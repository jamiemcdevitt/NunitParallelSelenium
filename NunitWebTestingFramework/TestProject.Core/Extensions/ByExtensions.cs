...
namespace TestProject.Core.Extensions
{
    public static class ByExtensions
    {
        ...
        public static void WaitForElementEnabled(this By by, IWebDriver driver, TimeSpan? timeout = null, bool suppressException = true)
        {
            var waitTimeout = timeout.IsNotNull() ? timeout.Value : AppConfig.ElementLoadWaitTime;
            try
            {
        ...
        public static void HoverOverPageElement(this By by, IWebDriver driver)
        {
